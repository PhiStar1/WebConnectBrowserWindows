...
Partial Class EnterAdminPassword
    ...
    Private Sub InitializeComponent()
        ...
        OrganizationPassword.PlaceholderText = "EnterAdminPassword.OrganizationPassword.PlaceholderText"
        OrganizationPassword.Size = New Size(699, 31)
        ...
        UnlockAdminSoftwareButton.Location = New Point(305, 73)
        UnlockAdminSoftwareButton.Name = "UnlockAdminSoftwareButton"
        UnlockAdminSoftwareButton.Size = New Size(414, 25)
        UnlockAdminSoftwareButton.TabIndex = 2
        UnlockAdminSoftwareButton.Text = "EnterAdminPassword.UnlockAdminSoftwareButton"
        ' 
        ' CancelButton
        ' 
        ...
        CancelButton.Size = New Size(288, 25)
        CancelButton.TabIndex = 3
        CancelButton.Text = "EnterAdminPassword.CancelButton"
        ' 
        ' EnterAdminPassword
        ' 
        ...
        Text = "WebConnect.EnterAdminPassword"
        ResumeLayout(False)
        PerformLayout()
    End Sub
